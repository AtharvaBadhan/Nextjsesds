...
export default function FooterFinal({BgColor}) {
  ...
  const handleCopy = (e,title) => {
    ...
    return (
            ...
            <section style={{background : bgcolor}} className={styles.footer_final}>
                <div className={styles.footer_final_container}>
                  <div className={styles.left_side}>
                        <div className={styles.social_contact}>
                            <div className={styles.mail_number}>
                            ...
                            <div className={styles.social_icon}>
                              <a target="_blank" herf={"https://www.youtube.com/@esdsdc"}><span><FaYoutube /></span></a>
                              <a target="_blank" herf={"https://www.instagram.com/esds.dc?igsh=NnQ4b2V4NmhuYWxu"}> <span><FaInstagram /></span></a>
                              <a target="_blank" herf={"https://x.com/esdsdatacenter"}> <span><FaXTwitter /></span></a>
                              <a target="_blank" herf={"https://www.linkedin.com/company/esdsdc/"}> <span><FaLinkedinIn /></span> </a>
                              <a target="_blank" herf={"https://www.facebook.com/ESDSdc"}>  <span><FaFacebookF /></span></a>
                            </div>
                        </div>

                        <div className={styles.ESDS_title}>
                        <Image
        src="/colocation/footer-ESDS.svg"
        alt="Footer ESDS"
        width={657}
        height={200}
      />
                    ...
                    <div className={styles.right_side}>
                        <div className={styles.innerpage_link}>
                            <a herf={'/cloud-services'}>Cloud Services</a>
                            <a herf={'/colocation-data-centre-services'}>Colocation Services</a>
                            <a herf={'/software-as-a-service'}>SaaS</a>
                            <a herf={'/managed-services'}>Managed Services</a>
                            <a herf={'/soc-as-a-service'}>Managed Security Services</a>
                            <a herf={'/platform-as-a-service'}>PaaS</a>
                            <a target="_blank" herf={'https://esds.co.in/esds-peoples/careers/'}>Careers</a>
                            <a target="_blank" herf={'https://esds.co.in/esds-peoples/news-events/'}>News & Events</a>
                            <a herf={'/about-esds'}>About</a>
                        </div>
                        ...
                        <div className={styles.last_link}>
                            <a target="_blank" herf={"https://www.esds.co.in/sitemap"}>Sitemap</a>
                            <a target="_blank" herf={"https://www.esds.co.in/service-level-agreement"}>Legal</a>
                            <a target="_blank" herf={"https://www.esds.co.in/cookie-policy"}>Cookies</a>
                            <a target="_blank" herf={"https://www.esds.co.in/support"}>Support</a>
                            <span>
