                  ...
                  <div className={styles.left_side}>
                        <div className={styles.social_contact}>
                            ...
                            <div className={styles.social_icon}>
                              <a target="_blank" to={"https://www.youtube.com/@esdsdc"}><span><FaYoutube /></span></a>
                              <a target="_blank" to={"https://www.instagram.com/esds.dc?igsh=NnQ4b2V4NmhuYWxu"}> <span><FaInstagram /></span></a>
                              <a target="_blank" to={"https://x.com/esdsdatacenter"}> <span><FaXTwitter /></span></a>
                              <a target="_blank" to={"https://www.linkedin.com/company/esdsdc/"}> <span><FaLinkedinIn /></span> </a>
                              <a target="_blank" to={"https://www.facebook.com/ESDSdc"}>  <span><FaFacebookF /></span></a>
                            </div>
                        </div>
      ...
      />
                    ...
                    <div className={styles.right_side}>
                        <div className={styles.innerpage_link}>
                            <a to={'/cloud-services'}>Cloud Services</a>
                            <a to={'/colocation-data-centre-services'}>Colocation Services</a>
                            <a to={'/software-as-a-service'}>SaaS</a>
                            <a to={'/managed-services'}>Managed Services</a>
                            <a to={'/soc-as-a-service'}>Managed Security Services</a>
                            <a to={'/platform-as-a-service'}>PaaS</a>
                            <a target="_blank" to={'https://esds.co.in/esds-peoples/careers/'}>Careers</a>
                            <a target="_blank" to={'https://esds.co.in/esds-peoples/news-events/'}>News & Events</a>
                            <a to={'/about-esds'}>About</a>
                        </div>
                        ...
                        <div className={styles.last_link}>
                            <a target="_blank" to={"https://www.esds.co.in/sitemap"}>Sitemap</a>
                            <a target="_blank" to={"https://www.esds.co.in/service-level-agreement"}>Legal</a>
                            <a target="_blank" to={"https://www.esds.co.in/cookie-policy"}>Cookies</a>
                            <a target="_blank" to={"https://www.esds.co.in/support"}>Support</a>
                            <span>
